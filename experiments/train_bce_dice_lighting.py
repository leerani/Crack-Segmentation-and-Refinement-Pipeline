...
BEST_MODEL_PATH = (
    CHECKPOINT_DIR
    / "unet_bce_dice_lighting_best.pth"
)
LAST_MODEL_PATH = (
    CHECKPOINT_DIR
    / "unet_bce_dice_lighting_last.pth"
)
...
def main() -> None:
    ...
    print(
        f"Loaded fixed split: {SPLIT_PATH}"
    )
    print(
        "Loss: 0.5 × BCE + 0.5 × Dice Loss"
    )
    print(
        "Train augmentation: brightness, "
        "contrast, gamma"
    )
    print(
