...
LAST_MODEL_PATH = (
    CHECKPOINT_DIR
    / "unet_bce_dice_balanced_lighting_last.pth"
)
...
def main() -> None:
    ...
    train_paths, val_paths = load_split(
        SPLIT_PATH
    )
    ...
    print(
        "Train lighting distribution: "
        "original 40%, low-light 30%, overexposed 30%"
    )
    ...
    for epoch in range(
        ...
        train_loss, lighting_counts = train_one_epoch(
            model,
            train_loader,
            criterion,
            optimizer,
        ...
        print(
            "  Lighting samples | "
            f"Original: {lighting_counts['original']} | "
            f"Low-light: {lighting_counts['low_light']} | "
            f"Overexposed: {lighting_counts['overexposed']}"
        )
        ...
        if val_dice > best_val_dice:
            ...
            checkpoint = {
                ...
                "augmentation": {
                    ...
                    "low_light": {
                        "brightness_scale": [0.25, 0.65],
                        "gamma": [1.3, 2.2],
                        "noise_std": [0.0, 0.025],
                    },
                    "overexposed": {
                        "contrast_scale": [1.1, 1.5],
                        "brightness_add": [30.0, 90.0],
                    },
                },
            }
